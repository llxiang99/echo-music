...
(function SnowModule(factory) {
    ...
    function Snow(option) {
        ...
        this.sinkspeed = option.sinkspeed || 1;
        // Set the maximum-size of your snowflakes
        this.snowmaxsize = option.snowmaxsize || 50;
        // Set the minimal-size of your snowflakes
        this.snowminsize = option.snowminsize || 10;
    ...
    Snow.prototype.initsnow = function() {
        if (this.ie5 || this.opera) {
            ...
            this.marginright = document.body.clientWidth - 100;
        } else if (this.ns6) {
            this.marginbottom = document.body.scrollHeight - 30;
            this.marginright = window.innerWidth - 30;
        }
